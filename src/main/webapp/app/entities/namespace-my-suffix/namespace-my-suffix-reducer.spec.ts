...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './namespace-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NAMESPACE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_NAMESPACES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_NAMESPACE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NAMESPACE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NAMESPACE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NAMESPACE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NAMESPACE actions', async () => {
      const expectedActions = [
        {
