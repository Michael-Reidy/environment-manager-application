...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './logical-location-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOGICALLOCATION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_LOGICALLOCATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_LOGICALLOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOGICALLOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOGICALLOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOGICALLOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOGICALLOCATION actions', async () => {
      const expectedActions = [
        {
