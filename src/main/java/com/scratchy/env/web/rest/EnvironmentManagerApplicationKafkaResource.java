...
import com.scratchy.env.config.KafkaSseConsumer;
import com.scratchy.env.config.KafkaSseProducer;
...
@RestController
@RequestMapping("/api/environment-manager-application-kafka")
public class EnvironmentManagerApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(EnvironmentManagerApplicationKafkaResource.class);
    ...
    public EnvironmentManagerApplicationKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
